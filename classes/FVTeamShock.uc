...
defaultproperties
{
      ...
      tProjs(0)=Class'LCWeapons_0025test.FV_RedShockProj'
      tProjs(1)=Class'LCWeapons_0025test.FV_BlueShockProj'
      tProjs(2)=Class'LCWeapons_0025test.FV_GreenShockProj'
      tProjs(3)=Class'LCWeapons_0025test.FV_GoldShockProj'
      tProjs(4)=Class'LCWeapons_0025test.FV_NoteamShockProj'
}
